...
export const CONTACT_EMAIL = process.env.NEXT_PUBLIC_CONTACT_EMAIL || "sales@partavio.com";
...
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Partavio";
