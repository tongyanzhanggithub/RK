// 用现有数据填充 Category / RepairGuide（幂等，可重复运行）
...
async function main() {
  ...
  console.log(`分类 upsert: ${names.length} 个`);
