  ...
  return (
    <form action={formAction} className="grid gap-6">
      ...
      <Section title="Images">
        <MainImageUpload name="image" label="Main Image / 主图" defaultValue={product?.image ?? ""} />
        <GalleryUpload name="imagesText" label="Gallery Images / 相册（每行：网址 | 说明 | primary）" defaultValue={images(product?.images)} />
      </Section>
