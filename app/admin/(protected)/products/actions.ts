...
const productSchema = z.object({
  ...
  fitmentType: z.enum(["SPECIFIC", "UNIVERSAL"]),
  fitmentNote: z.string().optional(),
  fitmentGuaranteed: z.boolean(),
...
function productDataFromForm(formData: FormData) {
  const parsed = productSchema.safeParse({
    ...
    salePrice: text(formData, "salePrice") || undefined,
    saleStartsAt: text(formData, "saleStartsAt") || undefined,
    saleEndsAt: text(formData, "saleEndsAt") || undefined,
    ...
    fitmentType: text(formData, "fitmentType") || "SPECIFIC",
    fitmentNote: text(formData, "fitmentNote"),
    fitmentGuaranteed: formData.get("fitmentGuaranteed") === "on",
  ...
  return {
    data: {
      ...
      salePriceCents: dollarsToCents(product.salePrice) ?? null,
