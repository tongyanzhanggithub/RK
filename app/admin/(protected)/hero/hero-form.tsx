...
function SubmitButton() {
  ...
  return (
    <button type="submit" disabled={pending} className="inline-flex h-11 items-center justify-center bg-safety px-6 font-black text-ink hover:bg-amber-400 disabled:opacity-60">
      {pending ? "保存中..." : "保存"}
    </button>
  );
}
